...
For the category experiment on local semantics, the accuracy per layer across the two models is shown in Figure~\ref{fig:accuracy_lines_per_layer_local}.
...
In Figure~\ref{fig:combined_metrics_heatmap}, we present a heatmap that summarizes the precision, recall, and F1 scores for the category experiment across all layers and models.
