...
from src.utils.experiment_utils import create_plots, get_repr, get_repr_for_layer, train_probe, load_captions_prompt, load_caption_ds
...
models = {
    "Qwen_Qwen2-VL-2B-Instruct": QwenVLProbe(model_name="Qwen/Qwen2-VL-2B-Instruct", device=device),
    "google_gemma-3-4b-it": AutoModelVLM(model_name="google/gemma-3-4b-it",device=device),
    "microsoft_Phi-4-multimodal-instruct": AutoModelVLM(model_name="microsoft/Phi-4-multimodal-instruct", device=device)
}
...
for model_name, model in models.items():
    ...
    num_dataset_items = len(1) #test mode
